...
Checkout [svgontheweb.com](https://svgontheweb.com) for more information about SVG and its [animation](https://svgontheweb.com/#animating) benefits.

## Preview

<img className="preview-image" src="https://github.com/ngeenx/nx-svg-loaders/blob/main/docs/static/img/nx-svg-loaders-preview.gif?raw=true" alt="SVG Loaders Preview"/>
